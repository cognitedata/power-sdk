...
class PowerClient(CogniteClient):
    def __init__(self, base_url="https://statnett.cognitedata.com", client_name="Cognite Power SDK", *args, **kwargs):
        ...
        self.transformers = GenericPowerAPI({"type": "CurrentTransformer"}, self.config, self._API_VERSION, self)
